defmodule Form do
  ...
  def letters(str1) do
    str1 |> String.upcase() |> String.split("", trim: true)
  end
  ...
  """
  @spec check_length(String.t(), non_neg_integer()) :: atom() | {:error, pos_integer()}
  def check_length(str1, num1) do
    num = String.length(str1) - num1
